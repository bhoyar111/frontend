...
const Questionnaire = () => {
  ...
  const isChildRoute = location.pathname !== "/questionnaire";
  ...
  const columns = [
    ...
    { key: "questionFor", label: "Question For" },
    // {
    //   key: "isActivated",
    //   label: "Status",
    //   render: (row) => (
  ...
  const actions = [
    {
      label: "Edit",
      icon: <Edit size={14} />,
      onClick: (row) => navigate(`/questionnaire/edit-question/${row._id}`),
    },
    {
      label: "Delete",
      icon: <Trash2 size={14} />,
  ...
  const topButtons = [
    {
      ...
      onClick: () => navigate("/questionnaire/add-question"),
    ...
    <>
      {!isChildRoute && (
        <ReuseableTable
          ...
          dropdownPlaceholder="All Types"
          dropdownOptions={dropDownData}
          onDropdownChange={handleDropdownChange}
          showQuesTypeFilter={true}
          quesTypeOptions={dropDownData}
